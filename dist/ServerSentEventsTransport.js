...
var ServerSentEventsTransport = /** @class */ (function () {
     ...
     */
    function ServerSentEventsTransport(request, accessTokenFactory, logger, logMessageContent, eventSourceConstructor) {
    ...
    ServerSentEventsTransport.prototype.connect = function (options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            var eventSource;
                            // 事件源
                            eventSource = new _this.eventSourceConstructor(options.url, {
    ...
    ServerSentEventsTransport.prototype.send = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, sendMessage(this.logger, "SSE", this.request, this.url, this.accessTokenFactory, data, this.logMessageContent)];
            });
        });
    };
